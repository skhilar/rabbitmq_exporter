...
var (
	...
	overviewMetricDescription = map[string]*prometheus.GaugeVec{
		"object_totals.channels":                    newGaugeVec("channelsTotal", "Number of channels.", overviewLabels),
		"object_totals.connections":                 newGaugeVec("connectionsTotal", "Number of connections.", overviewLabels),
		"object_totals.consumers":                   newGaugeVec("consumersTotal", "Number of message consumers.", overviewLabels),
		"object_totals.queues":                      newGaugeVec("queuesTotal", "Number of queues in use.", overviewLabels),
		"object_totals.exchanges":                   newGaugeVec("exchangesTotal", "Number of exchanges in use.", overviewLabels),
		"queue_totals.messages":                     newGaugeVec("queue_messages_total", "Number ready and unacknowledged messages in cluster.", overviewLabels),
		"queue_totals.messages_ready":               newGaugeVec("queue_messages_ready_total", "Number of messages ready to be delivered to clients.", overviewLabels),
		"queue_totals.messages_unacknowledged":      newGaugeVec("queue_messages_unacknowledged_total", "Number of messages delivered to clients but not yet acknowledged.", overviewLabels),
